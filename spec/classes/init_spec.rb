...
describe 'simp_gitlab' do
  shared_examples_for "a structured module" do
    ...
    it { is_expected.to contain_class('simp_gitlab::params') }
    it { is_expected.to contain_class('simp_gitlab::install').that_comes_before('simp_gitlab::config') }
    it { is_expected.to contain_class('simp_gitlab::config') }
    it { is_expected.to contain_class('simp_gitlab::service').that_subscribes_to('simp_gitlab::config') }
    ...
    on_supported_os.each do |os, facts|
      context "on #{os}" do
        ...
        context "simp_gitlab class without any parameters" do
          ...
          it { is_expected.to contain_class('simp_gitlab').with_client_nets( ['127.0.0.1/32']) }
        end
        ...
        context "simp_gitlab class with firewall enabled" do
          ...
          it { is_expected.to contain_class('simp_gitlab::config::firewall').that_comes_before('simp_gitlab::service') }
          it { is_expected.to create_iptables__add_tcp_stateful_listen('allow_simp_gitlab_tcp_connections').with_dports('1234') }
        end
        ...
        context "simp_gitlab class with selinux enabled" do
          ...
          it { is_expected.to contain_class('simp_gitlab::config::selinux').that_comes_before('simp_gitlab::service') }
        ...
        context "simp_gitlab class with auditing enabled" do
          ...
          it { is_expected.to contain_class('simp_gitlab::config::auditing').that_comes_before('simp_gitlab::service') }
        ...
        context "simp_gitlab class with logging enabled" do
          ...
          it { is_expected.to contain_class('simp_gitlab::config::logging').that_comes_before('simp_gitlab::service') }
